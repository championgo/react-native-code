...
import { Container, Right, Header, Left, Body, CheckBox } from "native-base";
      ...
      <View style={styles.row}>
        {rowData.id < 6 ? (
          ...
          >
            <View
              style={
                this.state.selectedLots.includes(rowData.id) == true
                  ? [styles.listStyle, { backgroundColor: "#292e4b" }]
                  : styles.listStyle
              }
            >
              <Text style={styles.desctext}>{rowData.title}</Text>
