...
export default class WalkthroughShopping extends Component {
  ...
  render() {
    ...
    const swiperImage =
      "https://antiqueruby.aliansoftware.net/Images/walkthrough/ic_bg_wt_02.png";
    ...
    return (
      <View style={{ backgroundColor: "#2d324f" }}>
        <Header style={styles.header}>
          ...
          <Body style={styles.headerBody}></Body>
            ...
            return (
              <View key={index} style={styles.slide}>
                ...
                <View style={styles.contentStyle}>
                  <Text style={styles.headertext}>{items.title}</Text>
                  <Text style={styles.desctext}>{items.type}</Text>
                  <Text style={styles.pricetext}>{items.price}</Text>
                  <TouchableOpacity
                    onPress={() => alert("Add to cart")}
                    style={styles.addToCartBg}
                  >
