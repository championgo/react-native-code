...
import { Icon, Right, Item, Input, Header, Left, Body } from "native-base";
...
export default class WalkthroughTicketBooking extends Component {
    ...
    const dataObjects = [
      {
        id: 1,
        image:
          "https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_one_wt_twentynine.png",
        title: "MALAYSIA"
      },
      {
        id: 2,
        image:
          "https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_two_wt_twentynine.png",
        title: "SINGAPORE"
      },
      {
        id: 3,
        image:
          "https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_three_wt_twentynine.png",
        title: "SWITZERLAND"
      },
      {
        id: 4,
        image:
          "https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_four_wt_twentynine.png",
        title: "FARNCE"
      },
      {
        id: 5,
            ...
            <Text
              style={
                this.state.selectedLots == rowData.id
                  ? styles.desctext
                  : [styles.desctext, { fontFamily: "SFUIDisplay-Thin" }]
              }
            >
              {rowData.title}
            </Text>
          ...
          <View style={styles.dataStyle}>
            {this.state.selectedLots == rowData.id ? (
              <Image
                ...
                style={styles.selectedDataImage}
              />
            ) : (
  ...
  render() {
    ...
    const swiperImage =
      "https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_bg_wt_twentynine.png";

    return (
      <ImageBackground
        source={{ uri: swiperImage }}
      ...
      >
        ...
        <View style={styles.slidesec}>
          ...
          <Text style={styles.headertext}>WHERE DO YOU WANT TO FLY FROM?</Text>
